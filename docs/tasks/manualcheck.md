...
malfunction
```
x If you have at least one ball and you can see the enemy, keep looking at the enemy, then throw the ball if it is at front of you. (attack)
x If you can see a ball and you have less than 4 balls, run to the ball. (collect)
x If there is nothing to do, rotate anti-clockwise (search)
x Priotize attack more than collect.
```
